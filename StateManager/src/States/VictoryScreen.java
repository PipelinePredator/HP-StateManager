...
public class VictoryScreen extends MenuState {
	...
	public VictoryScreen( GameFrame gameFrame) {
		...
		try {
			victoryImage = ImageIO.read(new File("res\\gameEnd\\victorry.png"));
		} catch (IOException e) {
	...
	public void render()
	{
		if(running)
		{
			...
			g = super.g;
			//draw Title
			g.drawImage(victoryImage,165 , 30, null);
